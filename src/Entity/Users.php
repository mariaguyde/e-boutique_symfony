...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CustomerAddress::class, mappedBy="users")
     */
    ...
    public function removeCustomerAddress(CustomerAddress $customerAddress): self
    {
        if ($this->customerAddress->removeElement($customerAddress)) {
            // set the owning side to null (unless already changed)
            if ($customerAddress->getUsers() === $this) {
                $customerAddress->setUsers(null);
            }
        }
