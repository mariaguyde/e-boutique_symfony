 ...
 */
final class Version20220304193938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE command_line ADD orders_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE command_line ADD CONSTRAINT FK_70BE1A7BCFFE9AD6 FOREIGN KEY (orders_id) REFERENCES `order` (id)');
        $this->addSql('CREATE INDEX IDX_70BE1A7BCFFE9AD6 ON command_line (orders_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_70BE1A7BCFFE9AD6 ON command_line');
        $this->addSql('ALTER TABLE command_line DROP orders_id');
