...
class __TwigTemplate_6d8eee66a39af3c1407e6ee8cd7c4afa57086a07faf42972fed16ddde08f84d1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 22
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 22, $this->source); })()), "description", [], "any", false, false, false, 22), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        ...
        echo "\">Retour à la liste des catégorie</a>
...
";
    ...
    {
        return array (  134 => 31,  129 => 29,  124 => 27,  116 => 22,  109 => 18,  102 => 14,  93 => 8,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Winnie's desk - Catégorie {{ category.name }}{% endblock %}
...
<div class=\"container\">
    ...
    <a href=\"{{ path('category_index') }}\">Retour à la liste des catégorie</a>

    <a href=\"{{ path('category_edit', {'id': category.id}) }}\">Modifier la catégorie</a>

    {{ include('category/_delete_form.html.twig') }}
</div>
{% endblock %}
", "category/show.html.twig", "/Users/guydefontgalland/e-boutique/templates/category/show.html.twig");
    }
}
