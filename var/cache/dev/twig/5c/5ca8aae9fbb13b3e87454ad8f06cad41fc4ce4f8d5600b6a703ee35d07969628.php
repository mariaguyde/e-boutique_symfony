...
class __TwigTemplate_98da7d6e3cf2c1aaf2809302a7b2f6d5c811e4bffdb663e5a4af4ff7ceed68b2 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Winnie's desk - Votre profil";
...
<div class=\"example-wrapper container\">
    <h1> <img style=\" height: 30px; margin-right: 10px;\" src=\"";
        // line 8
        ...
        echo "\" alt=\"icon d'une personne\"/> Votre profil</h1>
    <div>
        <p>Votre identifiant : ";
        // line 10
        ...
        // line 13
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 13, $this->source); })()), "phone", [], "any", false, false, false, 13), "html", null, true);
        echo "</p>

        <!--<p id=\"orders_list\"><img id=\"orders_icons\" src=\"images/clipboard.png\" alt=\"image d'un clipboard\"><a href=\"";
        // line 15
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("order_index");
        echo "\">Voir la liste des mes commandes</a></p>-->
    </div>


    <button><a href=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("updateProfil", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 19, $this->source); })()), "id", [], "any", false, false, false, 19)]), "html", null, true);
        echo "\">Modifier mon profil</a></button>
</div>
";
    ...
    {
        return array (  121 => 19,  114 => 15,  109 => 13,  105 => 12,  101 => 11,  97 => 10,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Winnie's desk - Votre profil{% endblock %}

{% block body %}

<div class=\"example-wrapper container\">
    <h1> <img style=\" height: 30px; margin-right: 10px;\" src=\"{{ asset('./images/user.png')}}\" alt=\"icon d'une personne\"/> Votre profil</h1>
    <div>
        <p>Votre identifiant : {{user.id}}</p>
        <p>Votre nom :  {{user.firstName}}</p>
        <p>Votre addresse mail :  {{user.email}}</p>
        <p>Votre numéro de téléphone :  {{user.phone}}</p>

        <!--<p id=\"orders_list\"><img id=\"orders_icons\" src=\"images/clipboard.png\" alt=\"image d'un clipboard\"><a href=\"{{ path('order_index')}}\">Voir la liste des mes commandes</a></p>-->
    </div>


    <button><a href=\"{{ path('updateProfil', {'id': user.id}) }}\">Modifier mon profil</a></button>
</div>
{% endblock %}
", "users/index.html.twig", "/Users/guydefontgalland/e-boutique/templates/users/index.html.twig");
    }
}
